...
В [следующей главе](03-ocp.md) мы изучим Принцип открытости/закрытости (OCP), который показывает, как расширять функциональность без изменения существующего кода.